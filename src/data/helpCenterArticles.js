...
export const helpCenterArticles = [
  { id: 1, title: 'Getting Started', category: 'Initial Setup', description: 'We will walk you through the process of connecting your Zoom account with your Zoomy Wordpress plugin on your website.', link: '/docs/intro', keywords: ['getting started', 'zoom account', 'wordpress plugin', 'setup', 'zoomy', 'connect'] },
